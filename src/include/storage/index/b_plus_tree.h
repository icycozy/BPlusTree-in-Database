...
class BPlusTree {
 ...
 private:
  ...
  auto IsSafePage(const BPlusTreePage *tree_page, Operation op, bool isRootPage = false) -> bool;
 ...
 public:
  ...
  void InsertIntoParent(const KeyType &key, page_id_t right_child_id, Context &ctx, int index);
